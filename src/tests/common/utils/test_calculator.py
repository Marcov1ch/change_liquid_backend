...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(1000, 5000, 5800, 200, StatusEnum.CRITICAL.value, id="critical_kritichno_200"),
        pytest.param(1000, 5000, 5900, 100, StatusEnum.CRITICAL.value, id="critical_kritichno_100"),
        pytest.param(1000, 5000, 5600, 400, StatusEnum.WARNING.value, id="warning_400"),
        pytest.param(1000, 5000, 5700, 300, StatusEnum.WARNING.value, id="warning_300"),
